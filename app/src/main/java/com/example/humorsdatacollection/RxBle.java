...
public class RxBle {
    ...
    private String DEVICE_MAME;

    public String getDEVICE_MAME() {
        return DEVICE_MAME;
    }

    public void setDEVICE_MAME(String DEVICE_MAME) {
        this.DEVICE_MAME = DEVICE_MAME;
    }
    ...
    private class BleGattCallback extends BluetoothGattCallback {
        ...
        public void onConnectionStateChange(BluetoothGatt bleGatt, int status, int newState) {
            ...
            if (newState == BluetoothGatt.STATE_CONNECTED) {
                ...
                setDEVICE_MAME(bleGatt.getDevice().getName());
